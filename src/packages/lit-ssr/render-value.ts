 ...
 * attributes.
 */
interface CustomElementAttributesOp {
 ...
 */
interface CustomElementShadowOp {
 ...
 * bindings.
 */
interface CustomElementClosedOp {
 ...
 */
interface PossibleNodeMarkerOp {
